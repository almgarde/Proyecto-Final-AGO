...
//			}
	...
	$('#addEdit').click(function() {
		...
		if ($('#authorSelectEdit').val() != '') {
			j++;
			$('#dynamic_fieldEdit').append('<tr id="row' + j + '"><td>' + j + '</td><td><input value="' + nameAuthor + '" id="inputAnyadirNameAuthorEdit" type="text" name="authorsPublication[' + (j - 1) + '].nameAuthor" class="form-control name_list" /></td><td><input value="' + shortNameAuthor + '" id="inputAnyadirShortNameAuthorEdit" type="text" name="authorsPublication[' + (j - 1) + '].shortNameAuthor" class="form-control name_list" /></td><td><button type="button" name="remove" id="' + j + '" class="btn btn-danger btn_removeEdit">X</button></td><input value="' + idMember + '" id="inputAnyadirIdMemberEdit" type="hidden" name="authorsPublication[' + (j - 1) + '].idMember" class="form-control name_list" /></tr>');
...
function mostrarModalUpdatePublication(idPublication, titlePublication, authorsPublication, journalPublication, doiPublication, yearPublication, active) {
	...
	authorsPublication.forEach(function(valor, indice, array) {
		j++;
		if (valor.idMember != '') {
			$('#dynamic_fieldEdit').append('<tr class="authorsList" id="row' + j + '"><td>' + j + '</td><td><input id="inputUpdateNameAuthor' + j + '" value="' + valor.nameAuthor + '" id="inputAnyadirNameAuthorEdit" type="text" name="authorsPublication[' + (j - 1) + '].nameAuthor" class="form-control name_list"></td><td><input id="inputUpdateShortNameAuthor' + j + '" value="' + valor.shortNameAuthor + '" id="inputAnyadirShortNameAuthorEdit" type="text" name="authorsPublication[' + (j - 1) + '].shortNameAuthor" class="form-control name_list"></td><td><button type="button" name="remove" id="' + j + '" class="btn btn-danger btn_removeEdit" data-is-member="true">X</button></td><input id="inputUpdateIdMember' + j + '" value="' + valor.idMember + '" type="hidden" name="authorsPublication[' + (j - 1) + '].idMember" class="form-control name_list"></tr>');
		} else {
